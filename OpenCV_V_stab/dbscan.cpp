...
const inline int region_query(const std::vector<ClusterPoint> &input, int p, std::vector<int> &output, double eps)
{
...
bool expand_cluster(const std::vector<ClusterPoint> &input, int p, std::vector<int> &output, int cluster, double eps, int min)
{
